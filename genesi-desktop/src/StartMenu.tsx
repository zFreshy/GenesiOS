    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="absolute bottom-24 left-1/2 z-[150] w-[600px] h-[700px] bg-[#1c1c1c]/90 backdrop-blur-3xl rounded-2xl border border-white/10 shadow-2xl flex flex-col text-white overflow-hidden"
        >
          {/* Top Search Bar */}
